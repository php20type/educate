...
<div class="main-content app-content">
    ...
    <div class="table-billing"> 
                        ...
                        <div class="row">
                            <div class="col-lg-4"> 
                                <select class="form-select" aria-label="Default select example">
                                    <option selected>Search by email</option>
        ...
        <div class="table-responsive"> 
            <table class="table table-dark" id="programTable">
                <thead>
                <tr>
                    <th scope="col">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-btn">
                                <a href="{{ route('programs.edit', $program->id) }}" class="btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
