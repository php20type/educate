                ...
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        ...
                        <ul class="dropdown-menu border-light-subtle py-3">
                            <li class="mb-3"><a class="dropdown-item border-bottom-1" href="{{ route('student.edit',auth()->user()->id) }}"><svg class="me-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
